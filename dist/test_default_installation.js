...
function enterRegistrationHA(code) {
    (0, helpers_1.it)("should allow setting registration HA", async function () {
        const sidebar = new sidebar_page_1.SidebarWithRegistrationPage(helpers_1.page);
        const registrationHA = new registration_enter_code_page_1.RegistrationEnterCodePage(helpers_1.page);
        await sidebar.goToRegistration();
        await registrationHA.fillCodeHA(code);
        await registrationHA.register();
    });
}
...
const options = (0, cmdline_1.parse)((cmd) => cmd
    ...
    .option("--registration-code-ha <code-ha>", "Registration code for High Availability")

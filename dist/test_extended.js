...
function verifyDecryptDestructiveActions(destructiveActions) {
    (0, helpers_1.it)("should display a list of destructive actions", async function () {
        ...
        await new storage_settings_page_1.StoragePage(helpers_1.page).expandDestructiveActionsList();
        for (const action of destructiveActions) {
            await new storage_settings_page_1.StoragePage(helpers_1.page).verifyDestructiveAction(action);
        }
    });
}

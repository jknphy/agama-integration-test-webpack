...
function verifyNotImplemented(num) {
    (0, helpers_1.it)("should display elements not implemented yet", async function () {
        ...
        await autoyastUnsupported.verifyNotImplementedText(num);
    });
}
...
class AutoyastUnsupportedPage {
    ...
    notImplementedText = (num) => this.page.locator(`::-p-text(Not implemented yet (${num}))`);
    ...
    async verifyNotImplementedText(num) {
...
const options = (0, cmdline_1.parse)((cmd) => cmd
    .option("--not-implemented <number>", "Number of not implemented yet elements")

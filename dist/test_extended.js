...
function verifyDecryptDestructiveActions() {
    const whatToCheck = [
    ...
    for (const action of whatToCheck) {
        (0, helpers_1.it)("should delete " + action, async function () {
...
(0, storage_result_destructive_actions_planned_1.verifyDecryptDestructiveActions)();

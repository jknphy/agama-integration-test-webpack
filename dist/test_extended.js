...
exports.decryptExistingDrive = decryptExistingDrive;
...
function decryptExistingDrive(password) {
...
/***/ "./src/checks/storage_check_decrypt_destructive_actions.ts":
/*!*****************************************************************!*\
  !*** ./src/checks/storage_check_decrypt_destructive_actions.ts ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.checkDecryptDestructiveActions = checkDecryptDestructiveActions;
const helpers_1 = __webpack_require__(/*! ../lib/helpers */ "./src/lib/helpers.ts");
const sidebar_page_1 = __webpack_require__(/*! ../pages/sidebar_page */ "./src/pages/sidebar_page.ts");
const storage_page_1 = __webpack_require__(/*! ../pages/storage_page */ "./src/pages/storage_page.ts");
function checkDecryptDestructiveActions() {
    (0, helpers_1.it)("should have correct destructive actions", async function () {
        const storage = new storage_page_1.StoragePage(helpers_1.page);
        const sidebar = new sidebar_page_1.SidebarPage(helpers_1.page);
        await sidebar.goToStorage();
        await storage.verifyDecryptDestructiveActions();
    });
}
...
const storage_check_decrypt_destructive_actions_1 = __webpack_require__(/*! ./checks/storage_check_decrypt_destructive_actions */ "./src/checks/storage_check_decrypt_destructive_actions.ts");
...
const options = (0, cmdline_1.parse)((cmd) => cmd
    ...
    .option("--decrypt-password <oassword>", "Password to decrypt an existing encrypted partition"));
...
(0, decryption_1.decryptExistingDrive)(options.decryptPassword);
(0, storage_check_decrypt_destructive_actions_1.checkDecryptDestructiveActions)();

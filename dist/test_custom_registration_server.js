...
function enterRegistrationRegUrl(code) {
    (0, helpers_1.it)("should allow setting registration", async function () {
        const sidebar = new sidebar_page_1.SidebarWithRegistrationPage(helpers_1.page);
        const productRegistration = new registration_page_1.CustomRegistrationPage(helpers_1.page);
        await sidebar.goToRegistration();
...
function enterCustomRegistrationServer(url) {
    (0, helpers_1.it)("should allow setting custom registration", async function () {
        const sidebar = new sidebar_page_1.SidebarWithRegistrationPage(helpers_1.page);
    ...
    (0, helpers_1.it)("should display product has been registered in registration page", async function () {
        const sidebar = new sidebar_page_1.SidebarWithRegistrationPage(helpers_1.page);
        const rmtRegistration = new registration_page_1.CustomRegistrationPage(helpers_1.page);
        await sidebar.goToRegistration();
    ...
    return class extends Base {
        ...
        async verifyCustomRegistration() {
            const elementText = await this.infoHasBeenRegisteredText()
                ...
                .wait();
            await strict_1.default.match(elementText, /SUSE Linux Enterprise Server/);
        }
    };
}

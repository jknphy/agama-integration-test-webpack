...
function parse() {
    ...
    commander_1.program
        ...
        .option("-z, --dasd", "Configure DASD storage (the default is not configure it)")
        .option("-i, --install", "Perform installation (the default is not install)")
        .parse(process.argv);
...
(0, node_test_1.describe)("Agama test", function () {
    ...
    (0, product_selection_1.productSelection)("openSUSE Tumbleweed");
